...
with DAG(
    ...
    create_table_task = PythonOperator(
        task_id="create_table_task", python_callable=create_table
    )

    insert_data_task = PythonOperator(
        task_id="insert_data_task", python_callable=insert_data
    )

    select_data_task = PythonOperator(
        task_id="select_data_task", python_callable=select_data, provide_context=True
    )

    print_data_task = PythonOperator(
        task_id="print_data_task", python_callable=print_data, provide_context=True
    )
